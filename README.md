...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-filer-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-filer-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-filer
# for installing globally
pixi global install django-filer
```
...
It is possible to list all of the versions of `django-filer` available on your platform:
...
```
pixi search django-filer --channel conda-forge
```
